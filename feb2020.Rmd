...
# and for fun we can facet_wrap on voice of the following segment
ggplot(diphthong_times,
       aes(x = time, y = F1, colour = vowel)) +
  geom_smooth(method = "gam",
              formula = y ~ s(x, k = 5)) + 
...
# or switch vowel/fol_voice
ggplot(diphthong_times,
       aes(x = time, y = F1, colour = fol_voice)) +
  geom_smooth(method = "gam",
              formula = y ~ s(x, k = 5)) + 
  scale_color_viridis_d() +
  facet_wrap(~vowel)
...
ggplot(diphthong_times,
       aes(x = time, y = F2, colour = fol_voice)) +
  geom_smooth(method = "gam",
              formula = y ~ s(x, k = 5)) + 
  scale_color_viridis_d() +
  facet_wrap(~vowel)
